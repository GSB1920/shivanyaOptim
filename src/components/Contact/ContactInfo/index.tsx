          ...
          <div className="flex md:flex-row flex-col items-center justify-center md:gap-28 gap-8">
            <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4">
              ...
              <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between">
                ...
                <div>
                  <Link href={`mailto:${config.email}`} className="text-primary text-18 font-medium flex items-center gap-3 group hover:text-midnight_text dark:hover:text-white">
                    Leave a message
                    <svg
                      width="23"
                      height="17"
            ...
            <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4">
              ...
              <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between">
                <div>
                  ...
                  <p className="text-DeepOcean font-normal text-xl max-w-80 pt-3 pb-7 dark:text-white dark:text-opacity-50">
                    We&apos;re growing. Send your resume to {config.email} or visit the Careers page.
                  </p>
                </div>
                <div>
                  <Link href={`tel:${config.phone}`} className="text-primary text-18 font-medium flex items-center gap-3 group hover:text-midnight_text dark:hover:text-white">
                    {config.phone}
                    <svg
                      width="23"
                      height="17"
