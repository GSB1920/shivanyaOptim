...
const Mobile = () => {
  ...
  return (
    <section className="dark:bg-darkmode overflow-x-hidden py-14 bg-gray-50">
        ...
        <div ref={ref} className="grid md:grid-cols-12 items-center lg:gap-12 gap-6">
          <motion.div {...leftAnimation} className="lg:col-span-6 col-span-12">
            ...
            <p className="mt-6 text-muted dark:text-white dark:text-opacity-70 lg:text-17 lg:max-w-full max-w-75%">
              Responsive applications that work seamlessly across iOS, Android, and Web platforms, ensuring your users have the best experience.
            </p>
